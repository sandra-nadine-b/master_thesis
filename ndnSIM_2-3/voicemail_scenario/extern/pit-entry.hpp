...
public: // out-record
  ...
  /**
   * @brief isSatisfied checks if the Interest Packet is already satisfied.
   * @return true when the Interest Packet is satisfied.
   */
  bool
  isSatisfied() const
  {
  ...
  /**
   * @brief setSatisfied sets a boolean variable if an Interest Packet is satisfied or not.
   * @param satisfied is true when the Interest Packet is satisfied.
   */
  void
